/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0602a65aec52dc5a79577a559a9081da)
// Runtime types generated with workerd@1.20250617.0 2025-06-20 
declare namespace Cloudflare {
	interface Env {
		FORCE_HTTPS?: string; // Can be "true", "false", or undefined
		WWW_REDIRECT?: string; // Can be "add", "remove", "none", or undefined
		ADMIN_KEY?: string; // Admin access key
		GIST_CONFIG_URL?: string; // External configuration URL for redirect rules
	}
}
